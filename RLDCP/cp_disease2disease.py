...
def save_img(image, path_pattern):
    ...
    # cv2.imwrite(path_pattern % i) data_new_all/BrownSpot_Pure_139/brownSpot_40


def main():
    root = Path('data_new_all')
    os.mkdir(root / "BrownSpot40_10" / "JPEGImages")
    os.mkdir(root / "BrownSpot40_10" / "SegmentationClass")
    root_img = root / "BrownSpot_Pure_139" / "brownSpot_40"/ "JPEGImages"
    root_mask = root / "BrownSpot_Pure_139" / "brownSpot_40" / "SegmentationClass"
    save_img = root / "BrownSpot40_10" / "JPEGImages"
    save_mask = root / "BrownSpot40_10" / "SegmentationClass"
