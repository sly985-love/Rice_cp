...
class MSCBlock(nn.Module):
    def __init__(self,in_channels,out_channels,atrous_rates):
        ...
        self.conv11=ConvBlock11(in_channels*2,out_channels)
...
class BLSNet(nn.Module):
    def __init__(self,in_channels,out_channels,features=[64,128,256,512],atrous_rates=[1,3,6,9]):
        ...
        for feature in reversed(features):
            self.ups.append(nn.ConvTranspose2d(feature,feature//2,kernel_size=3,stride=2))
            self.ups.append(BottleneckResblock(feature,feature//2))
        self.ups = self.ups[:6]
        ...
        self.msc=MSCBlock(in_channels,512,atrous_rates)
