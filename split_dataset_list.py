...
def parse_args():
    ...
    parser.add_argument('--dataset_root', help='the dataset root path', type=str,default=r'D:\草莓项目\数据集\mildew\split')
    parser.add_argument(
        '--images_dir_name', help='the directory name of images', type=str, default=r'D:\草莓项目\数据集\mildew\split\JPEGImages')
    parser.add_argument(
        '--labels_dir_name', help='the directory name of labels', type=str, default=r'D:\草莓项目\数据集\mildew\split\SegmentationClass')
    parser.add_argument(
